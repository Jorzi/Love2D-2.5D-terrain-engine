...
function loadGui()
    ...
    local filenameInput = luis.newTextInput(15, 3, "test", function(text) print(text) end, 5, 2)
    local button4 = luis.newButton("Save Game", 15, 3, function() saveGame(filenameInput.value) end, function()  end, 5, 2)
    local button5 = luis.newButton("Load Game", 15, 3, function() loadGame(filenameInput.value) end, function()  end, 5, 2)
    local button6 = luis.newButton("Clear", 15, 3, function() editState.activeTool = 'delete_brush' end, function()  end, 5, 2)
    ...
    container:addChild(filenameInput)
